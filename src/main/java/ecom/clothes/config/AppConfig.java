...
import ecom.clothes.service.UserServiceDetail;
...
public class AppConfig {
    ...
    public final CustomizeRequestFilter customizeRequestFilter;

    public final UserServiceDetail userDetailService;
